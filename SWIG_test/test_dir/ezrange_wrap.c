...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__ezrange

#else
#  define SWIG_init    init_ezrange

#endif
#define SWIG_name    "_ezrange"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_range(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:range",&obj0)) SWIG_fail;
  {
    npy_intp dims[1];
    if (!PyInt_Check(obj0))
    {
